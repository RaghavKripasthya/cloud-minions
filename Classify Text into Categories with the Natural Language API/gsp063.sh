...
echo "${BLUE_TEXT}${BOLD_TEXT}         SubScribe DevLabs.ai          ${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}=======================================${RESET_FORMAT}"
echo
...
# Completion message
echo
echo "${GREEN_TEXT}${BOLD_TEXT}------ Congratulations for Completing the lab || Do Like And Subscribe DevLabs.Ai!! ------${RESET_FORMAT}"
echo ""
