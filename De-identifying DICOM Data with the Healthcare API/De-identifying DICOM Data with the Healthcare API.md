...
## Solution [here](https://youtu.be/nVaNjvRBMoM)

```
export REGION=
``` 
```
curl -LO raw.githubusercontent.com/RaghavKripasthya/cloud-minions/main/De-identifying%20DICOM%20Data%20with%20the%20Healthcare%20API/gsp626.sh
